...
import th.team.stock.services.DropdownService;
...
@Slf4j
@RequestMapping("/stock-api/dropdown")

public class DropdownController implements ApiConstant{
    ...
    public ResponseEntity<Map<String, Object>> dropdownCategory(HttpServletRequest request, HttpServletResponse response,
            @RequestBody CategoryData data) {
        try {

            Map<String, Object> result = dropdownService.dropdownCategory(data);
